...
*@FileName : MoneyMgmtDBDAOSummarySearchTradeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MoneyMgmtDBDAOSummarySearchTradeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MoneyMgmtDBDAOSummarySearchTradeRSQL(){
		setQuery();
		...
		query.append("FileName : MoneyMgmtDBDAOSummarySearchTradeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
