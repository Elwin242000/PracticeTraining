...
<%@ page import="com.clt.apps.opus.esm.clv.practice1.errmsgmgmtprt.event.Practice1Event"%>
...
<div class="page_title_area clear">
	    <h2 class="page_title"><button type="button"><span id="title">Error Message Management</span></button></h2>
